...
import { ArrowLeft, Zap, CheckCircle2, Calendar, MapPin, Bell, ShieldCheck, MessageSquare, BarChart3, PlusCircle, Navigation, Leaf, Play, Layers, Monitor, Sparkles } from 'lucide-react';
            ...
            {product.features.map((feat) => {
              ...
              return (
                <div key={feat.title} className="card-dark" style={{ padding: '2rem' }}>
                  ...
                  <p style={{ fontSize: '0.95rem', color: 'var(--text-muted-dark)', lineHeight: 1.6 }}>{feat.desc}</p>
                </div>
              );
            })}
          </div>
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          <div className="card-dark" style={{ maxWidth: '800px', margin: '0 auto', padding: '3.5rem 2rem' }}>
            ...
            <p style={{ color: 'var(--text-muted-dark)', fontSize: '1.05rem', marginBottom: '2rem' }}>
              Connect with founders Atharsh S, Ajay KS, and Akash P for early previews, investment discussions, or product feedback.
            </p>
            <Link to="/contact" className="btn btn-coral" style={{ padding: '0.85rem 2rem' }}>
